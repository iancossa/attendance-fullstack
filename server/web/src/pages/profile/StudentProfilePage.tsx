      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-gray-600">Manage your personal information and achievements</p>
          </div>
        </div>
              ...
              <CardContent className="p-4 sm:p-6">
                <div className="flex flex-col items-center text-center space-y-4">
                  <Avatar className="h-20 w-20 ring-4 ring-orange-100">
                    <AvatarFallback className="text-xl bg-orange-100 text-orange-700">JD</AvatarFallback>
                  </Avatar>
                  <div>
            ...
            <Card className="border-l-4 border-l-orange-500">
              ...
              <CardContent className="space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm text-gray-700">john.doe@university.edu</span>
                </div>
                <div className="flex items-center gap-3">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm text-gray-700">Joined September 2022</span>
                </div>
              </CardContent>
            </Card>
          </div>
            ...
            <Card className="border-l-4 border-l-orange-500">
              ...
              <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  <p className="text-xs font-medium text-gray-600">Student ID</p>
                  <p className="font-medium text-gray-900">ST001</p>
                </div>
                <div className="space-y-2">
                  <p className="text-xs font-medium text-gray-600">Program</p>
                  <p className="font-medium text-gray-900">BTech - Computer Science</p>
                </div>
                <div className="space-y-2">
                  <p className="text-xs font-medium text-gray-600">Year</p>
                  <p className="font-medium text-gray-900">3rd Year</p>
                </div>
                <div className="space-y-2">
                  <p className="text-xs font-medium text-gray-600">CGPA</p>
                  <p className="font-medium text-green-600">8.5/10.0</p>
                </div>
                <div className="space-y-2">
                ...
                <div className="space-y-2">
                  ...
                  <p className="font-medium text-orange-600">85.50%</p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-l-4 border-l-orange-500">
              ...
              <CardContent className="space-y-3">
                {activities.map((activity, index) => (
                  <div key={index} className="flex items-center justify-between p-3 border border-gray-200 rounded-lg hover:border-orange-300 transition-colors">
                    <div>
                      <h4 className="font-medium text-gray-900">{activity.role}</h4>
                      <p className="text-sm text-gray-600">{activity.organization}</p>
                      <p className="text-xs text-gray-500">{activity.period}</p>
                    </div>
                    <Badge variant="outline" className="border-orange-300 text-orange-700">{activity.type}</Badge>
                  </div>
                ))}
              </CardContent>
            </Card>
