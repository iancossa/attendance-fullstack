      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-gray-600">Track your enrolled courses and attendance</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3 sm:gap-4">
            ...
            <CardContent className="pt-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <div className="text-2xl font-semibold text-gray-900 mt-1">{classes.length}</div>
          ...
          <Card className="border-l-4 border-l-orange-500">
            <CardContent className="pt-4">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-xs font-medium text-gray-600">Total Credits</p>
                  <div className="text-2xl font-semibold text-gray-900 mt-1">{totalCredits}</div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          {classes.map((classItem) => (
            <Card key={classItem.code} className="hover:shadow-md transition-shadow border-l-4 border-l-orange-500">
              <CardHeader className="pb-3">
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-600 mt-1">{classItem.code}</p>
                  </div>
              ...
              <CardContent className="space-y-3">
                <div className="grid grid-cols-2 gap-3 text-sm">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-gray-700">{classItem.credits} Credits</span>
                  </div>
                </div>
