...
const NotificationItem: React.FC<NotificationItemProps> = ({ notification, onClose }) => {
  ...
  const getBgColor = () => {
    switch (notification.type) {
      case 'success': return 'bg-green-50 border-green-200 dark:bg-green-900 dark:border-green-700';
      case 'error': return 'bg-red-50 border-red-200 dark:bg-red-900 dark:border-red-700';
      default: return 'bg-blue-50 border-blue-200 dark:bg-blue-900 dark:border-blue-700';
    }
  };
